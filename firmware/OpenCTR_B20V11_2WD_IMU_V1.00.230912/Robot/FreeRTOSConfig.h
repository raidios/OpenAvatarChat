...
#define configQUEUE_REGISTRY_SIZE				8                    //设置可以注册的信号量和消息队列个数 ,不为0时表示启用队列记录，具体的值是可以
...
//#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()  (FreeRTOSRunTimeTicks = 0ul) //定时器3提供时间统计的时基，频率为10K，即周期为100us
